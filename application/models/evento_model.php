...
class Evento_model extends CI_Model{
	...
	function get(){
		$this->db->select('evento, nombre, descripcion, fecha, contactos, duracion');
	...
	function save(){
		$datos = array(
			...
			'fecha'=>$this->security->xss_clean($this->input->post('fecha')),
                        'contactos'=>$this->security->xss_clean($this->input->post('contactos')),
		...
		if($id = $this->security->xss_clean($this->input->post('id'))){
			...
			$this->db->where('fecha',$this->security->xss_clean($this->input->post('fecha')));
                        $this->db->where('contactos',$this->security->xss_clean($this->input->post('contactos')));
